...
export declare const readRepoCommit: (datasource: DataSource, repoId: string, sha: string | null) => Promise<CommitData>;
export declare const readCurrentHistory: (datasource: DataSource, repoId?: string) => Promise<import("./repo").CommitHistory[]>;
export declare const readBranchHistory: (datasource: DataSource, repoId?: string, branchId?: string) => Promise<import("./repo").CommitHistory[]>;
export declare const readCommitHistory: (datasource: DataSource, repoId: string, sha: string | null) => Promise<import("./repo").CommitHistory[]>;
...
export declare const readBranchState: (datasource: DataSource, repoId?: string, branchId?: string) => Promise<import("./repo").ApplicationKVState>;
...
export declare const hasMergeConflictDiff: (datasource: DataSource, repoId: string) => Promise<boolean>;
...
export declare const canAutofixReversion: (datasource: DataSource, repoId: string, reversionSha: string) => Promise<boolean>;
